  ...
  return (
    <div className="fixed bottom-4 right-4 sm:bottom-6 sm:right-6 md:bottom-8 md:right-8 flex flex-col gap-3 z-50">
      ...
      >
        ...
        <span className="hidden sm:block absolute right-full mr-3 top-1/2 -translate-y-1/2 bg-[#25D366] text-white px-4 py-2 rounded-lg text-sm font-semibold whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity shadow-lg">
          WhatsApp
        </span>
      ...
      >
        ...
        <span className="hidden sm:block absolute right-full mr-3 top-1/2 -translate-y-1/2 bg-[#7360F2] text-white px-4 py-2 rounded-lg text-sm font-semibold whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity shadow-lg">
          Viber
        </span>
        <span className="absolute -top-1 -right-1 w-3 h-3 sm:w-4 sm:h-4 bg-red-500 rounded-full animate-pulse" />
      </a>
